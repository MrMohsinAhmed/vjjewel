    ...
    <div class="section-padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-12" style='border: 1px solid grey; border-radius: 5px; background-image: url("media/banner/bg-img-1.jpg")'>
                    <div class="card shadow-sm p-4">
                        <h2 class="text-center mb-4">Register</h2>
                        <div class="card-body" style="color:black;">
                            <form method="post" class="register" action="login.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mobilenumber" id="mobilenumber" maxlength="10" pattern="[0-9]{10}" placeholder="Enter your 10-digit mobile number" required>
                                </div>
                                <div class="form-group">
								...
								<div class="form-group text-center">
                                    <a href="login.php"><span>Already have an account? Click here to login</span></a>
